...
def mock_gcs():
    ...
    with patch("roar.services.get.backends.gcs.storage", None):
        ...
        import roar.services.get.backends.gcs as gcs_mod
...
class TestGCSDownloadBackend:
    ...
    def test_download_calls_gcs(self, mock_gcs, tmp_path: Path):
        ...
        from roar.services.get.backends.gcs import GCSDownloadBackend
