...
class TestS3DownloadBackend:
    ...
    def test_download_calls_boto3(self, tmp_path: Path):
        ...
        with patch("roar.services.get.backends.s3.boto3") as mock_boto3:
            mock_client = Mock()
            ...
            from roar.services.get.backends.s3 import S3DownloadBackend
    ...
    def test_exists_false_on_404(self):
        ...
        with (
            patch("roar.services.get.backends.s3.boto3") as mock_boto3,
            patch("roar.services.get.backends.s3.ClientError", ClientError),
        ):
            mock_client = Mock()
            mock_boto3.client.return_value = mock_client
